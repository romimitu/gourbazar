                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-dark sbold uppercase">Add New Product</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body form">
                            ...
                            <?php endif; ?>
                            <?php echo Form::open(['url' => '/product', 'method' =>'post', 'class'=>'form-horizontal','enctype'=>"multipart/form-data"]); ?>
