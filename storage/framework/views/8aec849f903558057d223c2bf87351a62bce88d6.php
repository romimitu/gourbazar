				...
				<?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	     		<div class="col-sm-3 time-line-event">
			        ...
			        <div class="above-line">
			          	...
			          	<h4 class="location-pin icon icon-ra_location"><?php echo e($team->position); ?></h4>
			          	<?php echo $team->description; ?>

	                    <div class="member-social">            
	                        <ul>
	                            <li><a href="mailto:<?php echo e($team->email); ?>"><i class="fa fa-envelope"></i></a></li>
	                            <li><a target="_blank" href="http://facebook.com/<?php echo e($team->facebook); ?>"><i class="fa fa-facebook"></i></a></li>
	                            <li><a target="_blank" href="http://twitter.com/<?php echo e($team->twitter); ?>"><i class="fa fa-twitter"></i></a></li>
	                        </ul>   
	                    </div>
			        </div>
